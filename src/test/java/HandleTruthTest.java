...
public class HandleTruthTest {
    ...
    public static ArrayList<TreeMap<Integer, Set<String>>> getTestCases() {
        ArrayList<TreeMap<Integer, Set<String>>> testCases = new ArrayList<>();

        // TEST CASE 1
        TreeMap<Integer, Set<String>> testCase1 = new TreeMap<>();
        Set<String> testCase1oneWord = new HashSet<>();
